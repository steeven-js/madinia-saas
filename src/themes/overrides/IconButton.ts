...
const colors = ['primary', 'secondary', 'success', 'error', 'warning', 'info'] as IconButtonColor[];

/***************************  COMPONENT - ICON BUTTON  ***************************/

export default function IconButton(theme: Theme) {
  const createColorVariant = (color: string, variant: string | undefined, styleFn: (paletteColor: PaletteColor) => object) => {
